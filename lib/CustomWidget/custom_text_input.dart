...
class CDTextInput extends StatefulWidget {
  const CDTextInput({
    super.key,
  ...
  _CDTextInputState createState() => _CDTextInputState();
}

// input text state
class _CDTextInputState extends State<CDTextInput> {
  ...
  OutlineInputBorder getBorder() {
    return OutlineInputBorder(
      ...
      borderSide: BorderSide(
          width: 2, color: widget.themeColor ?? const Color(0xff2980b9)),
      gapPadding: 2,
    );
  }
